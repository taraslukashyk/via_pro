    ...
    return (
        ...
        >
            <div className="flex flex-col h-full">
                ...
                {/* Toggle Button Text */}
                <motion.div layout="position" className="mt-auto pt-6 mb-[10px] flex items-center text-accent font-bold text-sm uppercase tracking-wider group-hover:translate-x-2 transition-transform">
