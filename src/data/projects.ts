export const PROJECTS = {
    ...
    en: [
        ...
        },
        {
            ...
            description: 'Construction of access roads and junction to the M-01 state highway (Kyiv – Chernihiv). Ensured compliance with the highest safety standards on the high-speed highway.',
            image: 'https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?q=80&w=2069&auto=format&fit=crop',
            lat: 50.5630,
            lng: 30.8320
        },
